...
import org.sonar.samples.java.checks.AvoidToManyParameterForMethodRule;
import org.sonar.samples.java.checks.AvoidTreeListRule;
import org.sonar.samples.java.checks.EnumRule;
import org.sonar.samples.java.checks.JAFClassNamingRule;
...
import org.sonar.samples.java.checks.SingletonRule;
import org.sonar.samples.java.checks.SpringCircuitBreakerRule;
import org.sonar.samples.java.checks.SpringControllerRequestMappingEntityRule;
import org.sonar.samples.java.checks.TOVariableNamingRule;
...
public final class RulesList {
  ...
  public static List<Class<? extends JavaCheck>> getJavaChecks() {
    return Collections.unmodifiableList(Arrays.asList(
      ...
      AvoidToManyParameterForMethodRule.class,
      EnumRule.class,
      SingletonRule.class,
      JAFClassNamingRule.class,
      TOVariableNamingRule.class,
      SpringCircuitBreakerRule.class));
  }
